<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Temp1.index" %>
        ...
        <div class="owl-carousel owl-banner">
            ...
            <div class="item item-3">
                <div class="header-text">
                    ...
                    <h2>Act Now!<br>
                        Get the highest level penthouse</h2>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="info-table">
                        <ul>
                            <li>
                                ...
                                <h4>250 m2<br>
                                    <span>Total Flat Space</span></h4>
                            </li>
                            <li>
                                <img src="assets/images/info-icon-02.png" alt="" style="max-width: 52px;">
                                <h4>Contract<br>
                                    <span>Contract Ready</span></h4>
                            </li>
                            <li>
                                <img src="assets/images/info-icon-03.png" alt="" style="max-width: 52px;">
                                <h4>Payment<br>
                                    <span>Payment Process</span></h4>
                            </li>
                            <li>
